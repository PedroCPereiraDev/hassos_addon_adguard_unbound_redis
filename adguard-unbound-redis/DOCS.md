...
4. Open the web UI (via the HA sidebar or `http://<your-ha-ip>:3000`) and log in
...
| **AdGuard Home web UI** | Most DNS and filtering settings can also be changed at `http://<your-ha-ip>:3000` or via the HA sidebar |
